...
// ── SHA-256 / HMAC / PBKDF2 → look/crypto_sha256.h (saf, RFC-KAT edilebilir) ─────
// Bu üçlü JWT/DKIM/session/auth'u besler; tanım tek noktada (drift yok).
using look::sha256;
using look::hmac_sha256;
using look::pbkdf2_sha256;
