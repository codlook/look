...
static thread_local EventLoop* tl_event_loop = nullptr;

EventLoop* get_thread_event_loop() noexcept { return tl_event_loop; }
void        set_thread_event_loop(EventLoop* loop) noexcept { tl_event_loop = loop; }
