...
> **Not:** `plesk bin extension --uninstall` adımı eklenti zaten kuruluysa başarısız olsa bile kurulum devam eder (`;` ile bağlanmıştır).
...
> `--uninstall` adımı eklenti zaten kuruluysa başarısız olsa bile devam eder.
