...
Plesk Panel → **Server Management → Terminal** acin ve su komutu calistirin:

```bash
plesk bin extension --install-url https://github.com/codlook/look/releases/download/v1.0.3/look-plesk-extension-1.0.3.zip
```
...
> **Alternatif:** Plesk panelinizde **Extensions → Upload Extension** butonu varsa ZIP dosyasini direkt yukliyebilirsiniz.
